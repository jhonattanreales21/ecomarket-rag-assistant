...
En cada caso comparamos un prompt básico contra un prompt mejorado con few-shot prompting, contexto estructurado y restricciones explícitas de comportamiento. El sistema combina Gemma 2B (ejecutado localmente con Ollama), datos estructurados de pedidos, un documento de política de devoluciones y una biblioteca de ejemplos de conversación. La interfaz de usuario se implementa con Streamlit.
